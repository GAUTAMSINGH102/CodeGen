require('dotenv').config({path: 'C:/Users/adity/Downloads/Open AI/.env'})
...
console.log('login',process.env.OPENAI_API)
const openai = new OpenAIApi(configuration);

function activate(context) {

	let writeCode = vscode.commands.registerCommand('CodeGen.write', async function () {
	...
	let codeConversion = vscode.commands.registerCommand('CodeGen.convert', async function () {
	...
	let generateDoc = vscode.commands.registerCommand('CodeGen.generate', async function () {
	...
	let sementicSearch = vscode.commands.registerCommand('CodeGen.search', async function () {
